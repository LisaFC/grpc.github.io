...
It assumes that you've read [What is gRPC?]({{site.baseurl}}/docs/concepts). For
language-specific details, see the Quick Start, tutorial, reference docs, and user guide for your chosen language(s),
where available (user guides for all languages are coming soon).
